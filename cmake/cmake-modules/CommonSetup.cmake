...
macro(CommonSetup)
    ...
    IF(UNIX)
        ...
        #message(WARNING "it is bad hahahahahahahahahahahaha ${CMAKE_CXX_COMPILER_ID}" )
        ...
        if (APPLE)
            ...
            if (${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
                #message(WARNING "it is good hahahahahahahahahahahaha")

                set(CMAKE_CXX_FLAGS "-stdlib=libc++ -Wno-documentation -Wno-unknown-warning-option ${CMAKE_CXX_FLAGS}")
                #set(CMAKE_CXX_FLAGS "-static ${CMAKE_CXX_FLAGS}")
                set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -lc++abi -lsupc++ ")
                #set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -lc++abi -lsupc++ ")

                find_package(LLVM REQUIRED CONFIG)
                set(CXX_EXP_LIB "-L${LLVM_LIBRARY_DIRS} -ferror-limit=10")
            else()
                #set(CMAKE_CXX_FLAGS "-nostdlib ${CMAKE_CXX_FLAGS}")
